...
from myfiles.models import Portfolio,Type,Murojaat
...
def index(malumot):
    ...
    if 'soz' in malumot.POST:
        ...
        text = text.strip()
        qidirish = Q(nomi__containswith = text)| Q(company_name__startswith=text)|\
        ...
        turlar = Type.objects.filter(qidirish)
